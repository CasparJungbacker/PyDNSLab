...
if config.backend == "cupy":
    try:
        import cupy as xp
        import cupyx.scipy.sparse as xs
        import cupyx.scipy.sparse.linalg as xsl
    except ImportError:
        import numpy as xp
        import scipy.sparse as xs
        import scipy.sparse.linalg as xsl
else:
    import numpy as xp
    import scipy.sparse as xs
    import scipy.sparse.linalg as xsl
...
class Operators:
    ...
    @staticmethod
    def poisson_matrix(grid: Grid) -> xs.spmatrix:
        """Poisson matrix"""
    ...
    @staticmethod
    def preconditioner(A: xs.spmatrix, N: int) -> xsl.LinearOperator:
        ilu = xsl.spilu(A)
        Mx = lambda x: ilu.solve(x)
        M = xsl.LinearOperator((N, N), Mx)
        return M
